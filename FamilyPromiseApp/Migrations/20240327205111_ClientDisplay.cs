...
{
    /// <inheritdoc />
    public partial class ClientDisplay : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferralAgencyID = table.Column<int>(type: "INTEGER", nullable: true),
                    IsEmployed = table.Column<string>(type: "TEXT", nullable: true),
                    Income = table.Column<string>(type: "TEXT", nullable: true),
                    IsHoused = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    Reason2 = table.Column<int>(type: "INTEGER", nullable: true),
